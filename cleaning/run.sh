...
python train.py --dataroot ./datasets/birds --name edge2birds --model pix2pix --no_flip --netG unet_256 --load_size 256 --crop_size 256 --netD n_layers --n_layers_D 3 --save_latest_freq 547 --save_epoch_freq 20 --display_id 0 --niter 200 --niter_decay 0 --batch_size 1 --input_nc 1 --output_nc 3 --dataset_mode twocat --print_freq 100 --update_html_freq 100 --num_classes 6 --class_csv class.csv

python test.py --dataroot ./datasets/birds --name edge2birds --model pix2pix --no_flip --netG unet_256 --load_size 256 --crop_size 256 --netD n_layers --n_layers_D 3 --batch_size 1 --input_nc 1 --output_nc 3 --dataset_mode twocat --num_classes 6 --class_csv class.csv
